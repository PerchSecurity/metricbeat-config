...
$BinDestination = "C:\Program Files\Elastic\Beats\7.17.5\metricbeat"
...
##Download Metricbeat
Write-Output "Downloading Metricbeat 7.17.5 MSI"
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
Invoke-WebRequest -Uri "https://artifacts.elastic.co/downloads/beats/metricbeat/metricbeat-7.17.5-windows-x86_64.msi" -OutFile "$env:TEMP\metricbeat-7.17.5-windows-x86_64.msi"
                        
##Install Metricbeat
Write-Output "Installing Metricbeat 7.17.5"
Write-Output "Press a key when Metricbeat install is finished"
Start-Process "$env:TEMP\.\metricbeat-7.17.5-windows-x86_64.msi" -wait
Write-Output "Press a key when Metricbeat install is finished"
